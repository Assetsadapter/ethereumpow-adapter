...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO ETHW", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "ETHW a", WalletID: walletID, Required: 1, Symbol: "ETHW", IsTrust: true}
