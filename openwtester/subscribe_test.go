...
type suETHWriberSingle struct {
}

//BlockScanNotify 新区块扫描完成通知
func (sub *suETHWriberSingle) BlockScanNotify(header *openwallet.BlockHeader) error {
	log.Notice("header:", header)
	return nil
}

//BlockTxExtractDataNotify 区块提取结果通知
func (sub *suETHWriberSingle) BlockExtractDataNotify(sourceKey string, data *openwallet.TxExtractData) error {
...
func (sub *suETHWriberSingle) BlockExtractSmartContractDataNotify(sourceKey string, data *openwallet.SmartContractReceipt) error {
...
func TestSuETHWribeAddress_ETHW(t *testing.T) {
